...
function login_success() {
    ...
    <div class="position-absolute top-0 end-0 mx-auto">
  <button class="btn ms-3 disabled text-dark"> Welcome to Rabbit Store ${username}!</button>
  <a href="cart.html" class="btn btn-success border-0 me-2">Cart (<span id="cart-quantity">0</span>)</a>
  <button onclick="logout()" class="btn btn-danger border-0">Logout</button></div>
  `;
}
...
function logout() {
    ...
    <div class="position-absolute top-0 end-0">
        <button class="btn btn-danger border-0 me-1 " data-bs-toggle="modal" data-bs-target="#frm-login">Login</button>
        <button class="btn btn-success border-0" data-bs-toggle="modal" data-bs-target="#frm-signup">Sign Up</button></div>`;
